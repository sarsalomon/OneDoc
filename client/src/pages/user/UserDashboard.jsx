...
<div>
      <nav className="sidebar-nav">
          ...
          <div className="right d-flex">
...

              {
                ...
                <div className="theme-dropdown">
                  {Object.keys(themes).map(themeName => (
                    ...
                    >
                      <img src={`./assets/sidebar/theme-icon-${themeName}.svg`} alt={`${themeName} theme`} />
                    </button>
                  ))}
                </div>
            ...
            <a href="tel:+998999367099" className='tel'>+998 {user.user.phone}</a>
      ...
      <div className={`container`} id='sidebar'>
        <div className={`sidebar ${isNavbarOpened ? `opened` : ``}`}>
          ...
          <div className="account-info"> 
            <div className="account-name">{user._user?.companyName === '' ? "Korxona ma'lumotlari kiritilmagan" : user._user?.companyName}</div>
        ...
        <div className="wrapper">
          {
            activeLink === 'Contract' ? <UserContractView /> : 
            activeLink === 'Application' ? <UserApplicationView /> :
            activeLink === 'Appeal' ? <UserAppealView /> :
            activeLink === 'Document' ? <UserDocumentView /> :
            activeLink === 'Signature' ? <UserSignatureView /> :
            activeLink === 'Sms' ? <UserSmsView /> :
            activeLink === 'Mail' ? <UserMailView /> :
            activeLink === 'Ocr' ? <UserOcrView /> :
            activeLink === 'Locker' ? <UserLockerView /> :
            activeLink === 'Account' ? <UserAccountView /> :
            null
          }
        </div>
      </div>
